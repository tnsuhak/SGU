...
@media(max-width:800px){.sgu-news-grid{grid-template-columns:1fr}.sgu-news-head{display:block}.sgu-news-head>a{display:inline-block;margin-top:15px}}
